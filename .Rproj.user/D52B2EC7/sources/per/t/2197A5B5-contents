...
campus_midd <- st_read(paste0(libDB, "Data Library/Dallas Independent School District/2024_2025 School Year/Middle_Attendance_Boundaries.geojson")) %>%
...
campus_high <- st_read(paste0(libDB, "Data Library/Dallas Independent School District/2024_2025 School Year/High_Attendance_Boundaries.geojson")) %>%
...
campuses_point <- st_read(paste0(libDB, "Data Library/Dallas Independent School District/2024_2025 School Year/Campus_Locations.geojson")) %>%
  st_transform(crs = 6584) %>%
